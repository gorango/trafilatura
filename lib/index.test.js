...
import { extract, extractWithOptions, extractBytes, extractBytesWithOptions } from './index.js'
...
describe('extractWithOptions', () => {
  test('outputMarkdown option produces markdown', () => {
    ...
    const result = extractWithOptions(html, { outputMarkdown: true })
  ...
  test('includeImages option extracts images', () => {
    ...
    const result = extractWithOptions(html, { includeImages: true })
  ...
  test('includeTables option includes table content', () => {
    ...
    const result = extractWithOptions(html, { includeTables: true })
  ...
  test('includeLinks option preserves links', () => {
    ...
    const result = extractWithOptions(html, { includeLinks: true })
  ...
  test('includeComments option', () => {
    ...
    const result = extractWithOptions(html, { includeComments: true })
  ...
  test('pageType option overrides classification', () => {
    ...
    const result = extractWithOptions(html, { pageType: 'product' })
  ...
  test('targetLanguage option', () => {
    ...
    const result = extractWithOptions(html, { targetLanguage: 'en' })
  ...
  test('url option provides context', () => {
    ...
    const result = extractWithOptions(html, { url: 'https://example.com/blog/post' })
  ...
  test('deduplicate option removes duplicates', () => {
    ...
    const result = extractWithOptions(html, { deduplicate: true })
  ...
  test('favorPrecision option uses stricter filtering', () => {
    ...
    const result = extractWithOptions(html, { favorPrecision: true })
  ...
  test('favorRecall option includes more content', () => {
    ...
    const result = extractWithOptions(html, { favorRecall: true })
  ...
  test('includeFormatting option preserves formatting', () => {
    ...
    const result = extractWithOptions(html, { includeFormatting: true })
...
describe('extractBytesWithOptions', () => {
  test('extracts bytes with options', () => {
    const html = '<html><body><article>Test</article></body></html>'
    const result = extractBytesWithOptions(Buffer.from(html), { outputMarkdown: true })
